...
# Configuration Script – CT-007 - Rev. A

This **Configuration** script is designed for the **CT-007** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – CT-007 Rev. A

Este script de **Configuration** está diseñado para el modelo **CT-007** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
